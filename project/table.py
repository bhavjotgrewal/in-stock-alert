...
import pyttsx3
from project import memoryexpress, newegg
...
list_newegg = newegg.load_data('data/newegg_products.txt')
list_m_e = memoryexpress.load_data('data/memory_express_products.txt')
...
with Live(table, refresh_per_second=2, vertical_overflow="visible"):
    while True:
        ...
        list_m_e = memoryexpress.in_stock_list(list_m_e)
